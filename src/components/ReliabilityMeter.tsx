...
const ReliabilityMeter = ({ score, className }: ReliabilityMeterProps) => {
  ...
  return (
    <div className={cn("relative flex items-center justify-center w-16 h-16", className)}>
      ...
      <div className={cn("absolute inset-0 flex items-center justify-center font-bold text-sm", colorClass)}>
        {currentScore}%
      </div>
    </div>
  );
